      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 lg:pt-32 pb-12 lg:pb-20">
        ...
        <div className="mt-20 lg:mt-32">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8">
            {/* AI & Technology */}
            <Link href="/biztech-hub" className="group text-center p-6 backdrop-blur-sm bg-white/5 rounded-2xl border border-hero-accent/30 hover:bg-hero-accent/10 transition-all duration-300 hover:-translate-y-2 block">
            ...
            {/* Sales & Growth */}
            <Link href="/biz-strategic-growth-center" className="group text-center p-6 backdrop-blur-sm bg-white/5 rounded-2xl border border-hero-accent/30 hover:bg-hero-accent/10 transition-all duration-300 hover:-translate-y-2 block">
            ...
            {/* Branding & Digital */}
            <Link href="/biz-creative-forge" className="group text-center p-6 backdrop-blur-sm bg-white/5 rounded-2xl border border-hero-accent/30 hover:bg-hero-accent/10 transition-all duration-300 hover:-translate-y-2 block">
              <div className="w-16 h-16 mx-auto mb-4 bg-hero-accent rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Finance & Legal */}
            <Link href="/biz-advisor" className="group text-center p-6 backdrop-blur-sm bg-white/5 rounded-2xl border border-hero-accent/30 hover:bg-hero-accent/10 transition-all duration-300 hover:-translate-y-2 block">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300" style={{backgroundColor: '#5D0E8B'}}>
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Investor Hub */}
            <Link href="/biz-advisor" className="group text-center p-6 backdrop-blur-sm bg-white/5 rounded-2xl border border-hero-accent/30 hover:bg-hero-accent/10 transition-all duration-300 hover:-translate-y-2 col-span-2 md:col-span-1 block">
              <div className="w-16 h-16 mx-auto mb-4 bg-hero-accent rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
